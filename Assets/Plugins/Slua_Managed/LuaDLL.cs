...
#pragma warning restore 414
    ...
    public class LuaNativeMethods
    {
        ...
        // Thread Funcs
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int lua_tothread(IntPtr ptr, int index);
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        ...
        {
            return LuaNativeMethods.lua_type(luaState, index) == LuaTypes.LUA_TNIL;
        }
        ...
        {
            return LuaNativeMethods.lua_type(luaState, index) == LuaTypes.LUA_TBOOLEAN;
        }
