...
public class Test : MonoBehaviour
{
    ...
    public class LuaTests
    {
        ...
        */
        ...
        {
            ObjectCache oc = ObjectCache.Get(lua.StatePointer);
        ...
        */
        ...
        public void AccessObjectStringProperty()
        {
            TestClass t1 = new TestClass()
            {
                TestStrval = "This is a string test"
            };
            lua["netobj"] = t1;
        ...
        */
        ...
        //		{
        //				lua.doString ("test=TestClass()");
        //				lua.doString ("setMethod=luanet.get_method_bysig(test,'setVal','string')");
        ...
        //		{
        //				lua.doString ("test=TestClass()");
        //				lua.doString ("setMethod=luanet.get_method_bysig(TestClass,'setVal','string')");
        ...
        //		{
        //				lua.doString ("make_method=luanet.get_method_bysig(TestClass,'makeFromString','string')");
        ...
        //		{		
        //				lua.doString ("test_cons=luanet.get_constructor_bysig(TestClass,'string')");
        ...
        {
            lua.DoString(@"print(string.Emptywaüäq?=()[&]ßstring.Empty)");
            Assert.IsTrue(true);
        }
        ...
        {
            TestClassWithOverloadedMethod obj = new TestClassWithOverloadedMethod();
            lua["obj"] = obj;
            lua.DoString(@" 
                            obj:Func (10)
                            obj:Func ('10')
